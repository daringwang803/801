...
void __init fttmr010_clockevent_init(void __iomem *base, int irq, unsigned long clk_freq);
void __init fttmr010_clocksource_init(void __iomem *base, unsigned long clk_freq);
